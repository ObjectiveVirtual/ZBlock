    ...
    <section id="about" class="py-20 bg-gray-800">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <!-- The image path has been updated to use the uploaded screenshot file name -->
                    <img width="353" height="146" alt="Screenshot 2025-09-06 203723" src="https://github.com/user-attachments/assets/68f4803c-3e5f-46d6-87c5-3173a5a41544" />
                </div>
                <div>
